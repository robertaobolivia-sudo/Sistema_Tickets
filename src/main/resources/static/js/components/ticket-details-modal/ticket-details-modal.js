...
import { canRegisterSatisfacao, isTicketFinalizado } from '@features/tickets/ticket-view-rules.js';
...
import { formatSatisfacaoNotaExibicao, formatSatisfacaoStatusLabel } from '@features/satisfacao/satisfacao-view.js';
...
const detailContatoWhatsappNome = document.getElementById('detailContatoWhatsappNome');
const detailContatoWhatsapp = document.getElementById('detailContatoWhatsapp');
const detailContatoWhatsappEmail = document.getElementById('detailContatoWhatsappEmail');
...
export async function openDetails(ticketNumber, fallbackSource) {
    ...
    try {
        ...
        detailContatoWhatsappNome.textContent = displayValue(ticket.contatoNome);
        detailContatoWhatsapp.textContent = displayValue(ticket.contatoWhatsapp);
        detailContatoWhatsappEmail.textContent = displayValue(ticket.contatoEmail);
